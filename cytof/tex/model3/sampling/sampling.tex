...
%type composes 36.3\% of the data across samples, while top two predominant cell
%types compose 68.17\% of the data across samples. Thus, we see infer that the
%rep-FAM is learning cell types that are distinct.
%%
