...
warrants the analysis of multiple parameters in shorter time \citep{cheung2001screening}. 
...
dimension reduction techniques and/or clustering-based approaches.  For
example,  {\tt introduce some existing approaches.  Explain a bit the methods
...
uncertainty associated with their inference.}  To overcome the limitations of
existing methods, we propose to develop novel Bayesian feature allocation
models (FAMs) embedded with clustering. 
