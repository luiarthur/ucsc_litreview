...
\bm\eta^0_{ij} &\iid \Dir_{L^0}(a_{\eta^0}, \ldots, a_{\eta^0}), \\
\bm\eta^1_{ij} &\iid \Dir_{L^1}(a_{\eta^1}, \ldots, a_{\eta^1}). 
\end{align*}
...
$$ where
$a^*_\ell = a_{\eta^z}+\sum_{n=1}^{N_i}\Ind{\gamma_{inj}=\ell ~\cap~ Z_{j\lin}=z}$.
