...
In Project 1, we use a FAM to learn the latent cell-types present in the
...
probability to redundant features. We therefore propose applying some
constraints the latent cell-type matrix so that in the prior, no cell-types can
be repeated. Moreover, cell-types that are more distinct are preferred over
cell-types that are very similar. We will extend the ideas by
\cite{petralia2012repulsive} to create a repulsive feature allocation model
(rep-FAM). This model will 
%TODO
