...
$$
  \logit(p_{inj}) = 
  \beta_{2i} \cdot y_{inj}^2  + \beta_{1i} \cdot y_{inj} + \beta_{0i}
  % \begin{cases}
...
\pause
\beginmyfig
\includegraphics[scale=.20]{results/img/prob_miss_example.pdf}
...
\begin{frame}{Project I: Priors}
\begin{align*}
\mus_{0\ell} \mid \psi_0, \tau^2_0 &\iid \text{Normal}_-(\psi_0, \tau^2_0), ~~~ \ell \in \bc{1, \dots,L^0} \\
\mus_{1\ell} \mid \psi_1, \tau^2_1 &\iid \text{Normal}_+(\psi_1, \tau^2_1), ~~~ \ell \in \bc{1, \dots,L^1} \\
...
\beta_{0i} &\iid \text{Normal}(m_{\beta_0}, s^2_{\beta_0}), ~~~ i \in \bc{1, \dots, I} \\
\beta_{1i} &\iid \text{Normal}(m_{\beta_1}, s^2_{\beta_1}), ~~~ i \in \bc{1, \dots, I} \\
\beta_{2i} &\iid \text{Normal}(m_{\beta_2}, s^2_{\beta_2}), ~~~ i \in \bc{1, \dots, I} \\
\end{align*}
\end{frame}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[scale=.30]{results/img/sim/Z1_true_noTranspose.pdf}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[scale=.35]{results/img/sim/Y001.png}
\end{tabular}
\end{center}
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/sim/YZ001.png}&
  \includegraphics[scale=.3]{results/img/sim/Z1_true.pdf}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ001_FlowSOM_SIM.png}&
  \includegraphics[scale=.3]{results/img/sim/Z1_true.pdf}\\
  {\small (a) Sample 1} & {\small(b) Z true} \\
  \end{tabular}
  \end{center}
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/cb/YZ001.png} &
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ001_FlowSOM_CB.png} \\
...
\begin{frame}{Project I: Conclusions and Future Work}
  Conclusions:
  \vspace{.5em}
  \begin{itemize}
    \setlength\itemsep{1em}
...
\frame{ %
  ...
  $$
  \begin{array}{rclcl}
    z_{jk} &\mid& v_k  &\sim& \text{Bernoulli}(v_k) \\
    v_k  &\mid& \alpha &\sim& \text{Beta}\p{\alpha/K,1} \\ 
  \end{array}
  $$
  for $j=1,\cdots J$ and $k=1,\cdots, K$, and where $\alpha$ is positive. \\
  \pause

  Then as $K\rightarrow \infty$, $\bm Z \sim \text{IBP}(\alpha)$. \pause
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/cb/pp_obs_i1_j1.pdf}&
  \includegraphics[scale=.3]{results/img/cb/pp_obs_i1_j2.pdf}\\
...
\begin{figure}
\begin{center}
  \includegraphics[scale=0.30]{results/img/cb/pz0_missy.pdf}
...
\begin{frame}{Project II: Feature Selection for Different Samples}
  \begin{itemize}
    ...
    \begin{figure}
      ...
      \includegraphics[scale=.1]{results/img/cb/YZ001.png} &
      \includegraphics[scale=.1]{results/img/cb/YZ002.png} &
      \includegraphics[scale=.1]{results/img/sim/YZ001.png} &
      \includegraphics[scale=.1]{results/img/sim/YZ002.png} \\
...
\begin{figure}
  \begin{center}
\begin{tabular}{c}
\includegraphics[scale=.3]{results/img/repFAM/Z1_true_noTranspose.pdf}
  \end{tabular}
 \end{center}
 \vspace{-0.05in}
\vspace{-0.05in} \caption{Simulation truth for $\bZ$ in Sample 1, with markers in
...
\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/repFAM/TRUE/YZ001.png}&
  \includegraphics[scale=.3]{results/img/repFAM/FALSE/YZ001.png}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
    \includegraphics[scale=.4]{results/img/sim/miss_mech_posterior.pdf}
  \end{center}
  \vspace{-0.05in}
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/cb/pp_obs_i2_j22.pdf}&
  \includegraphics[scale=.3]{results/img/cb/pp_obs_i3_j19.pdf}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/sim/YZ002.png}&
  \includegraphics[scale=.3]{results/img/sim/Z2_true.pdf}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/sim/YZ003.png}&
  \includegraphics[scale=.3]{results/img/sim/Z3_true.pdf}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ002_FlowSOM_SIM.png}&
  \includegraphics[scale=.3]{results/img/sim/Z2_true.pdf}\\
  {\small (a) Sample 2} & {\small(b) Z true} \\
  \end{tabular}
  \end{center}
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ003_FlowSOM_SIM.png}&
  \includegraphics[scale=.3]{results/img/sim/Z3_true.pdf}\\
  {\small (a) Sample 3} & {\small(b) Z true} \\
  \end{tabular}
  \end{center}
...
\vspace{-1em}\begin{figure}
  ...
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/cb/YZ001.png}&
  \includegraphics[scale=.3]{results/img/cb/YZ002.png}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/cb/YZ003.png} & \\
    {\small (c) Sample 3} &  \\
  \end{tabular}
  \end{center}
  \vspace{-0.05in}
...
\vspace{-1em}\begin{figure}
  ...
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ001_FlowSOM_CB.png}&
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ002_FlowSOM_CB.png}\\
  {\small (a) Sample 1} & {\small(b) Sample 2} \\
  \end{tabular}
  \end{center}
  \vspace{-0.05in}
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/FlowSOM/YZ003_FlowSOM_CB.png}&
  \includegraphics[scale=.3]{results/img/cb/YZ003.png}\\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/ksen/YZ001_K5.png}&
  \includegraphics[scale=.3]{results/img/ksen/YZ001_K10.png} \\
...
\vspace{-1em}\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/ksen/YZ001_K20.png}&
  \includegraphics[scale=.3]{results/img/ksen/YZ001_K10.png}\\
...
\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/repFAM/TRUE/YZ002.png}&
  \includegraphics[scale=.3]{results/img/repFAM/FALSE/YZ002.png}\\
  {\small (a) rep-FAM} & {\small(b) IBP} \\
  \end{tabular}
  \end{center}
  \vspace{-0.05in}
...
\begin{figure}
  \begin{center}
  \begin{tabular}{cc}
  \includegraphics[scale=.3]{results/img/repFAM/TRUE/YZ003.png}&
  \includegraphics[scale=.3]{results/img/repFAM/FALSE/YZ003.png}\\
  {\small (a) rep-FAM} & {\small(b) IBP} \\
  \end{tabular}
  \end{center}
  \vspace{-0.05in}
...
\begin{figure}
  \begin{center}
\begin{tabular}{c}
\includegraphics[scale=.3]{results/img/repFAM/Z_true_all.pdf}
  \end{tabular}
 \end{center}
 \vspace{-0.05in}
