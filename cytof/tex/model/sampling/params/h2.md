...
3. If $z_{jk}$ is unchanged, then the proposed state for $\mus_{jk}$ is simply
   ...
   $\tmus_{jk} \sim \N(\cdot \mid \psi_j, \epsilon^2, \tilde z_{jk})$ 
4. Compute the proposal density as 
   ...
   p(\tmus_{jk} \mid \psi_j, \epsilon^2, \tilde z_{jk})^{\Ind{\tilde z_{jk} \ne z_{jk}}}
   \\
   \end{split}
   $$
5. The proposed state $(\tilde h_{jk}, \tmus_{jk})$ will be
   ...
   %%%%%%%%%
   &= \frac{ p(\tilde  h_{jk} \mid \tilde \h_{-jk}) }{ p(h_{jk} \mid \h_{-jk}) }
   \bc{
     \frac{ p(\tmus_{jk} \mid \psi_j, \tau^2_j, \tilde z_{jk}) }{
   ...
   \bc{
   \frac{
     p(\mus_{jk} \mid \psi_j, \epsilon^2, z_{jk})
   }{
     p(\tmus_{jk} \mid \psi_j, \epsilon^2, \tilde z_{jk})
   }
   }^{\Ind{z_{jk}\ne \tilde z_{jk}}}
   \\
   \\ 
   ...
   \bc{
     \frac{
       p(y_{inj} \mid \tmus_{jk}, \sigma_i^2, \pi_{ij}, \tilde z_{j,k})
     }{
       p(y_{inj} \mid \mus_{jk}, \sigma_i^2, \pi_{ij}, z_{j,k})
     }
   }^{\Ind{z_{jk}\ne \tilde z_{jk}}}
   \end{align*}
6. Update $e_{inj}$.
