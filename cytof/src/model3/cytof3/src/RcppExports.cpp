...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fit_cytof_cpp(y, B, burn, prior_ls, locked_ls, init_ls, thin, thin_some, compute_loglike_every, print_freq, joint_update_freq, use_repulsive, show_timings, normalize_loglike, print_new_line, save_gam, update_z_by_column));
    return rcpp_result_gen;
END_RCPP
}
// shuffle_mat
